        ...
        <div class="container">
            ...
            <div class="section-wrapper">
                ...
                <div class="row mg-t-10">
                    ...
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <textarea name="body" id="body">{{dummy_content_service()}}</textarea>
                    </div>
                </div>
                <!-- row -->
            ...
            <div class="section-wrapper mg-t-20">
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input type="text" class="form-control" name="meta_title" placeholder="If leave empty default post title will be choosen">
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="meta_description" placeholder="If leave empty 180 words of description will be choosen">
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input type="text" class="form-control" name="meta_keywords" placeholder="Seperate Keywords with , like Keyword1,keyword2">
                    </div>
                </div>
                <!-- row -->
            </div>
            ...
            <div class="section-wrapper mg-t-20">
                ...
                <div class="form-layout-footer mg-t-30">
                    <button class="btn btn-primary bd-0 offset-6" type="submit">Create Page</button>
                </div>
                <!-- form-layout-footer -->
