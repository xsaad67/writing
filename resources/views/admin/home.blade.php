              ...
              <div class="table-responsive">
                <table class="table mg-b-0 tx-13">
                  ...
                  <tbody>
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img28.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img29.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img30.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img31.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img32.jpg" class="wd-55" alt="Image">
                      </td>
                      <td>
              ...
              <div class="table-responsive">
                <table class="table mg-b-0 tx-13">
                  ...
                  <tbody>
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img1.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img2.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img3.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img5.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
                    ...
                    <tr>
                      <td class="pd-l-20">
                        <img src="/db/img/img4.jpg" class="wd-36 rounded-circle" alt="Image">
                      </td>
                      <td>
        ...
        <div class="row row-sm mg-t-20">
            ...
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="/db/img/icon1.svg" class="wd-100" alt="">
                </div>
          ...
          <div class="col-lg-4 mg-t-20 mg-lg-t-0">
            <div class="card card-info">
              <div class="card-body pd-40">
                <div class="d-flex justify-content-center mg-b-30">
                  <img src="/db/img/icon2.svg" class="wd-100" alt="">
                </div>
