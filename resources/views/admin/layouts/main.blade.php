...
<head>
    ...
    <!-- vendor css -->
    <link href="{{asset('db/lib/font-awesome/css/font-awesome.css')}}" rel="stylesheet">
    <link href="{{asset('db/lib/Ionicons/css/ionicons.css')}}" rel="stylesheet">
    <link href="{{asset('db/lib/chartist/css/chartist.css')}}" rel="stylesheet">
    <link href="{{asset('db/lib/rickshaw/css/rickshaw.min.css')}}" rel="stylesheet">

    <!-- Slim CSS -->
    <link rel="stylesheet" href="{{asset('db/css/slim.css')}}">
  ...
  <body>
    ...
    <script src="{{asset('db/lib/jquery/js/jquery.js')}}"></script>

    <script src="{{asset('db/lib/bootstrap/js/bootstrap.js')}}"></script>
    <script src="{{asset('db/lib/popper.js/js/popper.js')}}"></script>
    <script src="{{asset('db/lib/jquery.cookie/js/jquery.cookie.js')}}"></script>
    <script src="{{asset('db/lib/d3/js/d3.js')}}"></script>
    <script src="{{asset('db/lib/jquery.sparkline.bower/js/jquery.sparkline.min.js')}}"></script>
     <script src="{{asset('db/js/slim.js')}}"></script>
