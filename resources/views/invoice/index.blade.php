	        ...
	        <div class="col-lg-12 col-md-12 col-sm-12">
	            ...
	            <div class="row">
		            ...
		            <div class="col-md-6">
		   				...
		   				<div class="col-md-10">
		   					<input type="text" class="form-control" name="title" placeholder="Essay Writing Service">
		   				</div>
		       		</div>
	            ...
	            <div class="row">
		            ...
		            <div class="col-md-4">
		   				<div class="col-md-1">
		   					<label class="custom-label" style="font-size:11px;">State</label>
		   				</div>
		   				<div class="col-md-11">
		       		...
		       		<div class="col-md-4">
		   				<div class="col-md-1">
		   					<label class="custom-label" style="font-size:11px;">Zip</label>
		   				</div>
		   				<div class="col-md-11">
		   			...
		   			<div class="col-md-4">
		   				<div class="col-md-1" >
		   					<label class="custom-label" style="font-size:11px;">Address</label>
		   				</div>
		   				<div class="col-md-11">
	            ...
	            <div class="row">
	            	<div class="col-md-6 col-md-offset-5">
	            		<button type="submit" class="btn btn-success btn-lg" >Generate Link</button>
	            	</div>
	            </div>
